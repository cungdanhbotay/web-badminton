      ...
      <table class="TableData">
        ...
        <tbody>
          ...
          <?php $i++;
                    ...
                    endforeach; ?>
          <td colspan="2" style="text-align: center; font-weight: bold; font-size: 15px;">Total Money</td>
          <td colspan="2" style="text-align: center;"><?= number_format($tongthanhtien, 0, ",", ".") ?></td>
        </tbody>
      </table>
      <div class="footer-left"> Can tho, ngay <?= date('d') ?> thang <?= date('m') ?> nam <?= date('Y') ?><br />
        Customer </div>
      <div class="footer-right"> Can tho, ngay <?= date('d') ?> thang <?= date('m') ?> nam <?= date('Y') ?><br />
      Staff </div>
    </div>
  </div>
</body>
