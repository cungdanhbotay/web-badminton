  ...
  <div class="container">
    ...
    <nav class="alert alert-light info">
      ...
      <div class="info-ship">
        <span>
          ...
          <button type="button" class="btn btn-outline-info btn-sm ml-3" data-toggle="modal"
    ...
    <div class="row mb-3">
      ...
      <div class="col style">
        ...
        <button type="button" class="btn btn-outline-info active">Payment on delivery <span class="badge"><i
              class="fa fa-check" aria-hidden="true"></i></span></button>
      </div>
      <div class="w-100"></div>
      <div class="line line-2"></div>
      <div class="col change">
        <div class="total-cost">
          ...
          <span>Total payment: <b><?= number_format(($row['giamoi'])*$soluongmua, 0, ",", ".") ?>
              <?= $row['donvitinh'] ?></b></span>
          <p>Product number (<?= $soluongmua ?>)</p>
        </div>
        <div class="footer">
          ...
          <a class="btn btn-outline-success btn-lg"
            href="/website_tmdt/customer/purchared.php?soluongmua=<?=$soluongmua?>&masp=<?= $masp ?>">Pay </a>
        </div>
