...
$sql_select_yeuthich = mysqli_query($conn, "SELECT * FROM yeuthich");
$count = mysqli_num_rows($sql_select_yeuthich);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  <div class="container">
    <div class="my-account-header page-title normal-title">
      <h1 style="text-align: center;">Product Like </h1>
    </div>
    ...
    <div class="page-wrapper my-account mb">
      <div class="container" role="main">
        ...
        <?php } else { ?>
          <div>
            <h1 style="height: 300px; text-align: center; margin-top: 200px;">There are currently no favorite products</h1>
          </div>
        <?php } ?>
