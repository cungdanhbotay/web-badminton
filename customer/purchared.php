      ...
      <div class="row gx-5">
        <div class="col">
          <form class="well form-horizontal" action="" method="post" id="contact_form">
            <fieldset>
              <!-- Form Name -->
              <legend class="name">Billing Information</legend>

              <!-- Text input-->

              <div class="form-group">
                <label class="col-md-4 text-lable">Email address*</label>
              ...
              <div class="form-group">
                <label class="col-md-4 text-lable">Name*</label>
                <div class="col inputGroupContainer">
                  <div class="input-group">
              ...
              <!-- Text input-->
              <div class="form-group">
                <label class="col-md-4 text-lable">Address*</label>
                <div class="col inputGroupContainer">
                  <div class="input-group">
              ...
              <div class="form-group">
                <label class="col-md-4 text-lable">Phone*</label>
                <div class="col inputGroupContainer">
                  <div class="input-group">
          ...
          <div class="title-acc">
            ...
            <span class="text-1"> New Product</span>
          </div>
          <div class="info">
            <label for="" class="text-lable text-2">Order notes (optional)</label>
            <textarea name="noigiaohang" id="noigiaohang" cols="10" rows="1" placeholder="Notes about the order, such as time or detailed delivery location instructions."></textarea>
          </div>
        ...
        <form action="" method="post" enctype="multipart/form-data">
          <div class="col ml-3">
            <h1 class="name">Order </h1>
            <?php if ($masp != null) { ?>
              <table class="table">
                <thead>
                  <tr style="border-bottom: 1px solid red;">

                    <th class="color-text">Product</th>
                    <th class="color-text">Temporary payment</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
              ...
              <div class="cache-price">
                <div class="cache text-secd ">Temporary payment</div>
                <div class="price price-buy"><?= number_format($arraysp['giamoi'] * $soluongmua, 0, ",", ".") ?>
                  <?= $arraysp['donvitinh'] ?></div>
              </div>
              <div class="total">
                <div class="title-cost text-secd ">Total Bill</div>
              ...
              <div id="accordion">
                <div class="card-group d-block">
                  <div class="css-card" id="headingOne">
                    <h5 class="mb-0">
                      <input class="" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" type="checkbox" checked>

                      </input>
                      <label class="css-card" for="" data-toggle="collapse" data-target="#collapseOne" aria-controls="collapseOne"> Payment on delivery (COD)</label>
                    </h5>
                  </div>

                  <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body css-card-1">
                    Please prepare cash in advance when receiving the goods
                    </div>
                  </div>
                </div>
                <div class="card-group d-block">
                  <div class="" id="headingTwo">
                    <h5 class="mb-0">
                      ...
                      <label class="css-card" for="" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> Pay directly at the store</label>
                    </h5>
                  </div>
                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                    <div class="card-body css-card-1">
                      Showroom – Q1,TP.sai gon
                    </div>
                  </div>
                </div>
                <div class="card-group d-block">
                  <div class="" id="headingThree">
                    <h5 class="mb-0">
                      ...
                      <label class="css-card" for="" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Online Payment & Online Installment </label>
                    </h5>
                  </div>
                  <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                    <div class="card-body css-card-1" style="max-width: 850px;">
                    To ensure successful payment, we check the product in stock and get back to you pine by email.
                       After responding, online payment gateways will be opened there.
            ...
            <div class="col">
              <div class="btn btnStyle"><input id="addSubmit" class="btn btn-outline font-weight-bold" style="color: #eef1f2;" name="btn_insert_ctdh" type="submit" value="Payment" onclick="check()">
              </div>
            </div>
            <div class="law color-law">
            By clicking Order, you agree to <ahref="">terms and condition</ahref=> and <a href="">privacy policy</a> ours.
            </div>
...
if (!empty($masp)) {
  ...
  VALUE ('$makh', '$ngaydathang', '$ngaygiaohang', '$ngaychuyenhang', '$noichon')";
    ...
    // Khi hủy đơn hàng update số lượng trong sản phẩm
