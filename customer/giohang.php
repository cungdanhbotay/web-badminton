...
<body>
  ...
  <div class="container">
    ...
    <div class="alert label" role="alert">
      ...
      <label for="" style="font-size: 20px; margin-left: 20px;">Quick select all </label>
    ...
    <form action="" method="POST">
      <table class="table" align="center" width="100%">
        ...
        <tr>
          ...
          <td> <img src="/website_TMDT/assets/uploads/sanpham/<?php echo $row_fetch_cart['hinhsanpham'] ?>" alt=""
      ...
      <div class="style-btn">
        <td colspan="2"><input type="submit" value="Update cart" name="capnhatgiohang" class="button-5"></td>
        <td colspan="2"><input type="submit" value="Delete product" name="remove[]" class="button-5 ml-2"></td>
        <td><input type="submit" value="Continue" name="continue" class=" ml-2 button-5"></td>
      </div>
    </form>
    ...
    <div class="row mb-3">
      ...
      <div class="col change">
        <div class="total-cost">
          ...
          ?>
          <span>Total Payment: <b><?php echo number_format($tongthanhtien, 0, ",", ".") . "đ" ?></b></span>
          <p>Product number (
            <?php
            $makh = $_SESSION['makh'];
        ...
        <form action="/../website_TMDT/customer/check.php" method="post">
          <fieldset>
            ...
            <input type="submit" name="thanhtoan" value="Pay" class="button-5">
  ...
  <?php } else { ?>
  <div>
    <h1 style="height: 300px; text-align: center; margin-top: 200px;">There are currently no products</h1>
  </div>
  <?php } ?>
