              ...
              <div class="badge-container absolute left top z-1">
                <div class="callout badge badge-circle">
                  <div class="badge-inner secondary on-sale">
                    <span
                      class="onsale">-<?= number_format((($mangsanpham['giacu'] - $mangsanpham['giamoi']) / $mangsanpham['giacu']) * 100, 0, ",", ".") ?>%</span>
                  </div>
                </div>
              </div>
                ...
                <div class="">
                  <form
                    ...
                    <fieldset>
                      ...
                      <input type="submit" name="themgiohang" value="Cart" class="btncard">
                      </input>
                    </fieldset>
                  </form>
                </div>
                  ...
                  <div class="">
                    <form action="/../website_TMDT/customer/giohang.php" method="post">
                      <fieldset>
                        ...
                        <input type="submit" name="themgiohang" value="Cart" class="btn btn-outline-info">
