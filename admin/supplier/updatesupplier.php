...
<body>
    <form class="form-horizontal" name="frmCreate" method="POST" enctype="multipart/form-data">
        <fieldset>
            <!-- Form Name -->
            <h2 class="text-center">Brand Update </h2>
            ...
            <!-- Select Basic -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="product_categorie"> Brand address</label>
                <div class="col-md-4">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="/website_tmdt/admin/supplier/getsupplier.php" name="btnQuayVe" class="btn btn-default">Return</a>
                    </div>
                </div>
        </fieldset>
    </form>
...
vừa thực thi:</b></br>$sqlUpdate");
        echo '<script type="text/javascript">alert("Successful product repair !")
        </script>';
    }
