...
<body>
    ...
    <form class="form-horizontal" name="frmCreate" method="POST" enctype="multipart/form-data">
        <fieldset>
            ...
            <!-- Form Name -->
            <h2 class="text-center">Add famous brand</h2>

            <!-- Text input-->
            <div class="form-group">
                <label class="col-md-4 control-label">famous brand </label>
                <div class="col-md-4">
                    <input name="tenth" placeholder="Brand" class="form-control input-md" type="text">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input name="diachith" placeholder="Address" class="form-control input-md" type="text">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input name="dienthoaith" placeholder="Phone " class="form-control input-md" type="text" >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href="/website_tmdt/admin/" name="btnQuayVe" class="btn btn-default">Cancel</a>
                    </div>
                </div>
...
if (isset($_POST['btnLuu'])) {
    ...
    // Rule2: min 3 ký tự
        ...
        $errors['tenth'][] = [
            ...
            'rule_value' => 3,
            'value' => $tenth,
            'msg' => 'Please enter the title of the story with 3 or more characters'
        ];
    }
