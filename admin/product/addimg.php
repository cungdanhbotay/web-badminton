...
<body>
    ...
    <form class="form-horizontal" name="frmCreate" method="POST" enctype="multipart/form-data">
        <fieldset>
            <h3 class="text-center">More product pictures: <?= $sanPham['tenhang'] ?></h3>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <a href="/website_tmdt/admin/product/getproduct.php" name="btnQuayVe" class="btn btn-default">Cancel</a>
                </div>
            </div>
    ...
    <div id="slide-wrap" style="text-align: center; margin-top: 150px;">
        <?php foreach ($danhSachHinh as $items) : ?>
            <img style="width: 100px; height: 100px" src="/website_tmdt/assets/uploads/sanpham/<?= $items['tenha'] ?>" alt="">
        <?php endforeach ?>
    </div>
