...
<input type="checkbox" id="nav-toggle">
    ...
    <div class="main-content">
        ...
        <div><a class="btn btn-primary" style="margin-top: 118px; margin-left: 10px" href="./addproduct.php">Add</a></div>
               
        <?php include_once(__DIR__ . '/../partials/header.php'); ?>
        <h4 style="text-align: center;">To add an image for a product click on the product name</h4>
