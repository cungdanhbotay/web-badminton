...
<body class="d-flex flex-column h-100">
  ...
  <form class="form-horizontal" name="frmCreate" method="POST" enctype="multipart/form-data" autocomplete="off">
    <fieldset>
      <!-- Form Name -->
      <h2 class="text-center">Change product information</h2>

      <!-- Text input-->
      <div class="form-group">
        <label class="col-md-4 control-label">Product name</label>
        <div class="col-md-4">
          <input name="tenhang" placeholder="Tên sản phẩm" value="<?= $sanphamRow['tenhang'] ?>"
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="soluong" name="soluong" placeholder="Quantity" value="<?= $sanphamRow['soluong'] ?>"
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input name="donvitinh" placeholder="Unit" value="<?= $sanphamRow['donvitinh'] ?>"
            class=" form-control input-md" type="text">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input name="giamoi" placeholder="New price" value="<?=$sanphamRow['giamoi']?>" class="form-control input-md"
            required="" type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="giacu" name="giacu" placeholder="Old price" value="<?=$sanphamRow['giacu']?>" class="form-control"
            type="text">
        </div>
      </div>
      ...
      <div style="margin-left: 0" class="form-group">
        ...
        <div class="col-md-4">
          <img style="width:200px;" src="/website_TMDT/assets/uploads/sanpham/<?= $sanphamRow['hinhsp'] ?>"
            class="hinh-daidien" alt="" id="preview-img">
          <input id="hinhsp" name="hinhsp" class="input-file" type="file" accept=".jpg, .jpeg, .png, .gif">
        </div>
      </div>

      <h4 class="text-center">Detailed </h4>
      <div class="form-group">
        <label class="col-md-4 control-label"> Brand</label>
        <div class="col-md-4">
          <input id="object1" name="object1" value="<?= $sanphamRow['object1']?>" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object2" name="object2" value="<?= $sanphamRow['object2']?>" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object3" name="object3" value="<?= $sanphamRow['object3']?>" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object4" name="object4" value="<?= $sanphamRow['object4']?>" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object5" name="object5" value="<?= $sanphamRow['object5']?>" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object6" name="object6" value="<?= $sanphamRow['object6']?>" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object7" name="object7" value="<?= $sanphamRow['object4']?>" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object8" name="object8" value="<?= $sanphamRow['object8']?>" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object9" name="object9" value="<?= $sanphamRow['object9']?>" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-4 control-label">SFlexibility</label>
        <div class="col-md-4">
          <input id="object10" name="object10" value="<?= $sanphamRow['object10']?>" class="form-control input-md"
            type="text">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input id="object11" name="object11" value="<?= $sanphamRow['object11']?>" class="form-control input-md"
            type="text">
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <button name="btnSua" class="btn btn-primary">Save Now</button>
