...
<body>
    ...
    <form class="form-horizontal" name="frmCreate" method="POST" enctype="multipart/form-data">
        <fieldset>
            ...
            <!-- Form Name -->
            <h2 class="text-center">Edit product type</h2>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <button name="btnUpdate" class="btn btn-primary">Update now</button>
                    <a href="/website_tmdt/admin//product-type/get-product-type.php" name="btnQuayVe" class="btn btn-default">Return</a>
                </div>
            </div>
        </fieldset>
    </form>
