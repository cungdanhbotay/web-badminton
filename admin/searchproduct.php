...
<input type="checkbox" id="nav-toggle">
    ...
    <div class="main-content">
        ...
        <div><a class="btn btn-primary" style="margin-top: 118px" href="./addproduct.php">ADD</a></div>
        ...
        <table class="table table-bordered" style="margin-top: 10px;">
            ...
            <?php if ($arraysp != null) { ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-secondary" href="./updateproduct.php?masp=<?= $sanpham['masp'] ?>">
                                <i class="fa fa-pencil" aria-hidden="true"></i>Fix</a>
                            <br>
                ...
                <?php endforeach; ?>
                <?php } else { ?>
          <div class="nono" style="text-align: center ;"><h1>This product is not available</h1></div>
        <?php } ?>
            </tbody>
        </table>
