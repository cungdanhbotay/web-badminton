...
<body onload="window.print();">
  <div class="">
    <div id="page" class="page">
      <div class="header">
        <div class="logo"><img src="../../assets/Baophan.png" /></div>
      ...
      <div class="footer-left"> Can tho, date <?= date('d') ?> month <?= date('m') ?> Year <?= date('Y') ?><br />
        Customer </div>
      <div class="footer-right"> Can tho, date <?= date('d') ?> month <?= date('m') ?> Year <?= date('Y') ?><br />
        staff </div>
    </div>
  </div>
</body>
